...
class ReviewsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'reviews_ibfk_1' => ['type' => 'foreign', 'columns' => ['game_id'], 'references' => ['games', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2020-10-14 22:23:11',
                'modified' => '2020-10-14 22:23:11',
            ],
        ];
        parent::init();
    }
